...
export class AuthController {
  ...
  @UseGuards(AuthGuard("jwt"), AdminGuard)
  @Get("admins")
  async getAdmins(@Query("page") page = "1", @Query("limit") limit = "10", @Query("search") search = "") {
  ...
  @UseGuards(AuthGuard("jwt"), AdminGuard)
  @Put("admin/:id")
  async updateAdmin(@Param("id", ParseIntPipe) id: number, @Body() dto: Partial<RegisterAdminAuthDto & { id: number }>) {
